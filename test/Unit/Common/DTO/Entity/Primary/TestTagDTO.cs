...
namespace WorldZero.Test.Unit.Common.DTO.Entity.Primary
{
    ...
    public class TestTagDTO
    {
        ...
        public void Setup()
        {
            ...
            this._desc = "foo";
            this._dto = new TagDTO(this._id, this._desc);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as TagDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new TagDTO(this._id, this._desc);
            Assert.AreEqual(this._dto, alt);
            alt = new TagDTO(null, this._desc);
            Assert.AreNotEqual(this._dto, alt);
            alt = new TagDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new TagDTO(this._id, this._desc);
            Assert.AreEqual(this._dto, alt);
            alt = new TagDTO(null, this._desc);
            Assert.AreNotEqual(this._dto, alt);
            alt = new TagDTO(this._id, null);
