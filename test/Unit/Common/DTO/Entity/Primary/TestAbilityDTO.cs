...
{
    [TestFixture]
    public class TestAbilityDTO
    {
        private Name _id;
        private string _desc;
        private AbilityDTO _dto;
        ...
        public void Setup()
        {
            ...
            this._desc = "foo";
            this._dto = new AbilityDTO(this._id, this._desc);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as AbilityDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new AbilityDTO(this._id, this._desc);
            Assert.AreEqual(this._dto, alt);
            alt = new AbilityDTO(null, this._desc);
            Assert.AreNotEqual(this._dto, alt);
            alt = new AbilityDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new AbilityDTO(this._id, this._desc);
            Assert.AreEqual(this._dto, alt);
            alt = new AbilityDTO(null, this._desc);
            Assert.AreNotEqual(this._dto, alt);
            alt = new AbilityDTO(this._id, null);
