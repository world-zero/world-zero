...
{
    [TestFixture]
    public class TestTaskFlagDTO
    {
        private Id _id;
        private Id _leftId;
        private TaskFlagDTO _dto;
        ...
        public void Setup()
        {
            ...
            this._dto = new TaskFlagDTO(this._id, this._leftId);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as TaskFlagDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new TaskFlagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new TaskFlagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new TaskFlagDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new TaskFlagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new TaskFlagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new TaskFlagDTO(this._id, null);
