...
{
    [TestFixture]
    public class TestTaskTagDTO
    {
        private Id _id;
        private Id _leftId;
        private TaskTagDTO _dto;
        ...
        public void Setup()
        {
            ...
            this._dto = new TaskTagDTO(this._id, this._leftId);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as TaskTagDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new TaskTagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new TaskTagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new TaskTagDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new TaskTagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new TaskTagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new TaskTagDTO(this._id, null);
