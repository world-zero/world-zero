...
namespace WorldZero.Test.Unit.Common.DTO.Entity.Relation
{
    ...
    public class TestFriendDTO
    {
        ...
        public void Setup()
        {
            ...
            this._dto = new FriendDTO(this._id, this._leftId);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as FriendDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new FriendDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new FriendDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new FriendDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new FriendDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new FriendDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new FriendDTO(this._id, null);
