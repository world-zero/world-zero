...
{
    [TestFixture]
    public class TestPraxisTagDTO
    {
        private Id _id;
        private Id _leftId;
        private PraxisTagDTO _dto;
        ...
        public void Setup()
        {
            ...
            this._dto = new PraxisTagDTO(this._id, this._leftId);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as PraxisTagDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new PraxisTagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new PraxisTagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new PraxisTagDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new PraxisTagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new PraxisTagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new PraxisTagDTO(this._id, null);
        ...
        {
            var s = new HashSet<PraxisTagDTO>();
            s.Add(this._dto);
