...
{
    [TestFixture]
    public class TestCommentFlagDTO
    {
        private Id _id;
        private Id _leftId;
        private CommentFlagDTO _dto;
        ...
        public void Setup()
        {
            ...
            this._dto = new CommentFlagDTO(this._id, this._leftId);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as CommentFlagDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new CommentFlagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new CommentFlagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new CommentFlagDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new CommentFlagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new CommentFlagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new CommentFlagDTO(this._id, null);
        ...
        {
            var s = new HashSet<CommentFlagDTO>();
            s.Add(this._dto);
