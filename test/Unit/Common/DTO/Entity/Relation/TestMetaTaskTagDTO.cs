...
{
    [TestFixture]
    public class TestMetaTaskTagDTO
    {
        private Id _id;
        private Id _leftId;
        private MetaTaskTagDTO _dto;
        ...
        public void Setup()
        {
            ...
            this._dto = new MetaTaskTagDTO(this._id, this._leftId);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as MetaTaskTagDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new MetaTaskTagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new MetaTaskTagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new MetaTaskTagDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new MetaTaskTagDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new MetaTaskTagDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new MetaTaskTagDTO(this._id, null);
        ...
        {
            var s = new HashSet<MetaTaskTagDTO>();
            s.Add(this._dto);
