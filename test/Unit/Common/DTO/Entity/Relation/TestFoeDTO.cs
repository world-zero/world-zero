...
namespace WorldZero.Test.Unit.Common.DTO.Entity.Relation
{
    ...
    public class TestFoeDTO
    {
        ...
        public void Setup()
        {
            ...
            this._dto = new FoeDTO(this._id, this._leftId);
        }
        ...
        {
            Assert.AreEqual(this._dto, this._dto.Clone() as FoeDTO);
        }

        [Test]
        public void TestEqualsObject()
        {
            object alt = new FoeDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new FoeDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new FoeDTO(this._id, null);
            Assert.AreNotEqual(this._dto, alt);
        }
        ...
        {
            var alt = new FoeDTO(this._id, this._leftId);
            Assert.AreEqual(this._dto, alt);
            alt = new FoeDTO(null, this._leftId);
            Assert.AreNotEqual(this._dto, alt);
            alt = new FoeDTO(this._id, null);
