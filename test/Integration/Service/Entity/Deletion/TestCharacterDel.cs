...
namespace WorldZero.Test.Integration.Service.Entity.Deletion
{
    ...
    public class TestCharacterDel
    {
        ...
        private void _allAbsentt()
        {
            ...
            this._absentt<Praxis, Id, int>(this._praxis00_10, this._praxisRepo.GetById);
            this._absentt<Praxis, Id, int>(this._praxis00, this._praxisRepo.GetById);
            this._absentt<Praxis, Id, int>(this._praxis01, this._praxisRepo.GetById);
            this._absentt<Praxis, Id, int>(this._praxis10, this._praxisRepo.GetById);
            this._absentt<PraxisParticipant, Id, int>(this._pp0010_00, this._ppRepo.GetById);
            this._absentt<PraxisParticipant, Id, int>(this._pp0010_10, this._ppRepo.GetById);
            this._absentt<PraxisParticipant, Id, int>(this._pp00, this._ppRepo.GetById);
            this._absentt<PraxisParticipant, Id, int>(this._pp01, this._ppRepo.GetById);
            this._absentt<PraxisParticipant, Id, int>(this._pp10, this._ppRepo.GetById);
            this._absentt<Comment, Id, int>(this._commentBy00on10, this._commentRepo.GetById);
            this._absentt<Comment, Id, int>(this._commentBy00on10Again, this._commentRepo.GetById);
            this._absentt<Comment, Id, int>(this._commentBy01on10, this._commentRepo.GetById);
            this._absentt<Comment, Id, int>(this._commentBy01on10Again, this._commentRepo.GetById);
            this._absentt<Comment, Id, int>(this._commentBy10on00, this._commentRepo.GetById);
            this._absentt<Comment, Id, int>(this._commentBy10on00Again, this._commentRepo.GetById);
        ...
        private void _allPresent()
        {
            ...
            this._present<Praxis, Id, int>(this._praxis00_10, this._praxisRepo.GetById);
            this._present<Praxis, Id, int>(this._praxis00, this._praxisRepo.GetById);
            this._present<Praxis, Id, int>(this._praxis01, this._praxisRepo.GetById);
            this._present<Praxis, Id, int>(this._praxis10, this._praxisRepo.GetById);
            this._present<PraxisParticipant, Id, int>(this._pp0010_00, this._ppRepo.GetById);
            this._present<PraxisParticipant, Id, int>(this._pp0010_10, this._ppRepo.GetById);
            this._present<PraxisParticipant, Id, int>(this._pp00, this._ppRepo.GetById);
            this._present<PraxisParticipant, Id, int>(this._pp01, this._ppRepo.GetById);
            this._present<PraxisParticipant, Id, int>(this._pp10, this._ppRepo.GetById);
            this._present<Comment, Id, int>(this._commentBy00on10, this._commentRepo.GetById);
            this._present<Comment, Id, int>(this._commentBy00on10Again, this._commentRepo.GetById);
            this._present<Comment, Id, int>(this._commentBy01on10, this._commentRepo.GetById);
            this._present<Comment, Id, int>(this._commentBy01on10Again, this._commentRepo.GetById);
            this._present<Comment, Id, int>(this._commentBy10on00, this._commentRepo.GetById);
            this._present<Comment, Id, int>(this._commentBy10on00Again, this._commentRepo.GetById);
        ...
        private Praxis _praxis00_10;
        private Praxis _praxis00;
        private Praxis _praxis01;
        private Praxis _praxis10;
        private PraxisParticipant _pp0010_00;
        private PraxisParticipant _pp0010_10;
        private PraxisParticipant _pp00;
        private PraxisParticipant _pp01;
        private PraxisParticipant _pp10;
        private Comment _commentBy00on10;
        private Comment _commentBy00on10Again;
        private Comment _commentBy01on10;
        private Comment _commentBy01on10Again;
        private Comment _commentBy10on00;
        private Comment _commentBy10on00Again;
        ...
        public void Setup()
        {
            ...
            this._friend00_01 = new Friend(this._c0_0.Id, this._c0_1.Id);
            this._friend10_01 = new Friend(this._c1_0.Id, this._c0_1.Id);
            this._friend00_10 = new Friend(this._c0_0.Id, this._c1_0.Id);
            ...
            this._praxis00_10 = new Praxis(taskId0, pt, status, areDueling: true);
            this._praxis00 = new Praxis(taskId0, pt, status);
            this._praxis10 = new Praxis(taskId0, pt, status);
            this._praxis01 = new Praxis(taskId0, pt, status);
            ...
            this._pp0010_00 = new PraxisParticipant(this._praxis00_10.Id, this._c0_0.Id);
            this._pp0010_10 = new PraxisParticipant(this._praxis00_10.Id, this._c1_0.Id);
            this._pp00 = new PraxisParticipant(this._praxis00.Id, this._c0_0.Id);
            this._pp01 = new PraxisParticipant(this._praxis01.Id, this._c0_1.Id);
            this._pp10 = new PraxisParticipant(this._praxis10.Id, this._c1_0.Id);
            ...
            this._commentBy00on10 = new Comment(this._praxis10.Id, this._c0_0.Id, "x");
            this._commentBy00on10Again = new Comment(this._praxis10.Id, this._c0_0.Id, "x", 2);
            this._commentBy01on10 = new Comment(this._praxis10.Id, this._c0_1.Id, "x");
            this._commentBy01on10Again = new Comment(this._praxis10.Id, this._c0_1.Id, "x", 2);
            this._commentBy10on00 = new Comment(this._praxis00.Id, this._c1_0.Id, "x");
            this._commentBy10on00Again = new Comment(this._praxis00.Id, this._c1_0.Id, "x", 2);
